...
import {WhatsappChatBoxTypes} from "./WhatsappChatBox.types";
import Emoti from './svgs/emoti.svg'
import EmojiPicker from "emoji-picker-react";
import WhatsappEditor from "../WhatsappEditor/WhatsappEditor";

const WhatsappChatBox:React.FC<WhatsappChatBoxTypes> = ({ value, onChange, title, max }) => {
